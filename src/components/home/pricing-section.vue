  ...
  <section id="pricing" class="relative px-6 py-24 bg-white border-t border-zinc-200">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="text-center md:text-left mb-16">
        ...
        <p class="mt-4 text-zinc-600 max-w-2xl">Des solutions adaptées à tous les budgets pour concrétiser vos projets
          digitaux</p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        ...
        <div class="p-8 rounded-xl bg-white border border-zinc-200">
          ...
          <a href="https://cal.com/justany-itoua" target="_blank"
            class="mt-6 w-full py-3 px-6 rounded-full bg-zinc-900 text-white font-medium hover:bg-zinc-800 transition-colors inline-flex items-center justify-center">
            Réserver un appel
        ...
        <div class="p-8 rounded-xl bg-zinc-900 border border-zinc-800 text-white">
          ...
          <a href="https://cal.com/justany-itoua" target="_blank"
            class="mt-6 w-full py-3 px-6 rounded-full bg-gradient-to-r from-orange-600 to-orange-400 text-white font-medium hover:from-orange-700 hover:to-orange-500 transition-colors inline-flex items-center justify-center">
      ...
      <div class="mb-14">
        <div class="flex justify-center space-x-4 border-b border-zinc-200">
          <button class="px-6 py-3 text-sm font-medium transition-colors relative"
      ...
      <div v-show="activeTab === 'services'" class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div v-for="rate in serviceRates" :key="rate.id"
          ...
          <!-- Gradient Background -->
          <div
            class="absolute inset-0 bg-gradient-to-br from-orange-500/5 to-orange-500/0 opacity-0 group-hover:opacity-100 rounded-2xl transition-opacity duration-500">
          </div>
          ...
          <div class="relative">
            ...
            <div class="flex items-start justify-between mb-6">
              <div class="flex-1">
                <div class="flex items-center space-x-3 mb-2">
                  ...
                  <div
                    class="px-3 py-1 rounded-full bg-zinc-100 border border-zinc-200 text-zinc-700 text-sm font-medium">
                    {{ rate.unit }}
                  </div>
                </div>
            ...
            <div class="space-y-6">
              ...
              <ul v-if="rate.features" class="space-y-3">
                <li v-for="(feature, index) in rate.features" :key="index" class="flex items-center text-zinc-600">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3 text-orange-500" fill="none"
            ...
            <div class="mt-8 flex justify-center">
              <router-link to="/devis"
                class="w-full inline-flex px-6 py-3 border border-transparent text-base font-medium rounded-full shadow-sm text-white bg-black hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black items-center justify-center">
                Demander un devis
      ...
      <div v-show="activeTab === 'packs'" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <template v-for="plan in pricingPlans" :key="plan.id">
          <div class="relative p-8 rounded-xl bg-white border transition-all duration-300 hover:shadow-xl flex flex-col"
            :class="[
            ...
            <div class="text-center mb-8">
              <h3 class="text-2xl font-bold" :class="plan.name === 'Enterprise' ? 'text-zinc-950' : 'text-zinc-900'">
                {{ plan.name }}
              </h3>
            ...
            <ul class="space-y-6 flex-grow">
              <li v-for="(feature, index) in plan.features" :key="index"
                ...
                <div class="flex items-center text-zinc-900">
                  <svg v-if="feature.included" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 text-orange-500"
                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round">
                    <polyline points="20 6 9 17 4 12"></polyline>
                  </svg>
                  <svg v-else xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 text-zinc-400" viewBox="0 0 24 24"
            ...
            <div class="mt-8">
              <button
                class="w-full py-3 px-6 rounded-full font-medium transition-all duration-300 inline-flex items-center justify-center"
                :class="plan.popular ?
