...
<template>
  <div class="bg-zinc-50/70 border-y border-zinc-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-24">
      <!-- En-tête -->
      <div class="text-left mb-16">
        <h1 class="text-4xl font-bold bg-gradient-to-r from-zinc-800 to-zinc-500 inline-block text-transparent bg-clip-text">
          Blog & Actualités
        </h1>
